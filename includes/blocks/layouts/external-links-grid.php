...
if( have_rows('external_links') ):
  ...
  while( have_rows('external_links') ) : the_row();
      ...
      <a class="flex flex-col lg:flex-row group items-center bg-neutral-light-100 lg:bg-primary-default rounded-md overflow-hidden" href="<?php the_sub_field('link');?>" rel="external" aria-label="Read <?php echo $title;?>">
      <?php if($img) {
