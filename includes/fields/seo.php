  ...
  if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
      ...
      'fields' => array(
        ...
        array(
          'key' => 'field_62b19ec8h9xc45',
          'label' => 'Podcasts Page Settings',
          'name' => '',
          'type' => 'accordion',
          'instructions' => '',
          'required' => 0,
        ...
        array(
          'key' => 'field_62b17d75x88f3',
          'label' => 'Header',
          'name' => 'podcast_header',
          'type' => 'image',
          'instructions' => 'Set the image that will display at the top of your main Podcast page.',
          'required' => 0,
          'conditional_logic' => 0,
          'wrapper' => array(
            'width' => '',
        ...
        array(
          'key' => 'field_62b1a0ba3n7k4',
          'label' => 'Description',
          'name' => 'podcast_page_description',
          'type' => 'textarea',
          'instructions' => '<p>Add a short description for your Podcast page. To use this in a theme template, use the following code:</p><code>$description = get_field("podcast_page_description", "options");</code>',
          'required' => 0,
          'conditional_logic' => 0,
          'wrapper' => array(
            'width' => '',
          ...
          'default_value' => '',
          'placeholder' => 'Add a short description for your Podcasts page',
          'maxlength' => '',
          'rows' => '',
          'new_lines' => '',
        ),
        array(
          'key' => 'field_62b1a61z234v6',
          'label' => 'Use transparent image layout',
          'name' => 'podcast_page_transparent_header',
          'type' => 'true_false',
          'instructions' => 'If you are using an image with a transparent background, you can turn this setting on to adapt the layout to show the header background colour behind the image.',
          'required' => 0,
          'conditional_logic' => 0,
